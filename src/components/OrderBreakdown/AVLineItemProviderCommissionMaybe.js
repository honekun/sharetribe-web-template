...
/**
 * AV replacement for upstream `LineItemProviderCommissionMaybe`, swapped in by
 * OrderBreakdown. It differs from upstream in two ways: percentage and fixed
 * provider commissions are summed into a single row, and the label links to the
 * seller FAQ. Upstream's own component is left untouched so it keeps merging
 * cleanly.
 *
 * @component
 * @param {Object} props
 ...
 * @returns {JSX.Element}
 */
const AVLineItemProviderCommissionMaybe = props => {
...
export default AVLineItemProviderCommissionMaybe;
